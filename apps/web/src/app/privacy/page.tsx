  ...
  return (
    ...
    >
      <section className="space-y-2">
        ...
        <p>
          Ao utilizar o eufaço!, coletamos as seguintes informações pessoais em
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Número de WhatsApp (apenas para prestadores de serviço)</li>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold">2. Base Legal para o Tratamento</h2>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <strong>Consentimento:</strong> Fornecido no momento do cadastro na
            plataforma
          </li>
          <li>
            <strong>Execução de contrato:</strong> Necessário para a prestação
            dos serviços da plataforma
          </li>
          <li>
            <strong>Legítimo interesse:</strong> Para melhorar a experiência do
            usuário e a segurança da plataforma
          </li>
        </ul>
      </section>

      <section className="space-y-2">
        <h2 className="text-lg font-semibold">3. Como Utilizamos suas Informações</h2>
        <ul className="list-disc pl-5 space-y-1">
          <li>Criar e gerenciar sua conta na plataforma</li>
          <li>Exibir perfis de prestadores para clientes interessados</li>
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <strong>Outros usuários:</strong> Nome, foto e informações do
            perfil profissional são visíveis publicamente para usuários
            autenticados
          </li>
          <li>
            <strong>Prestadores de infraestrutura:</strong> Utilizamos serviços
            da Supabase para armazenamento de dados e autenticação, e da Vercel
            para hospedagem
          </li>
        </ul>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold">7. Cookies e Dados de Navegação</h2>
        <p>
          Utilizamos cookies essenciais para manter sua sessão ativa e garantir
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          dos seus dados pessoais, entre em contato através do suporte
